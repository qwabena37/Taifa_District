...
const images = [
  {
    src: '/images/Congregational/Lg1.jpeg',
    caption: 'Renovation of Achimota Bus Stop Shelter by PCG - Logos Congregation',
  },
  {
    src: '/images/Congregational/Lg2.jpeg',
    caption: 'Renovation of Achimota Bus Stop Shelter by PCG - Logos Congregation',
  },
  
]

export function Congregational() {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 px-4">
      <h3 className="text-2xl font-semibold text-white mb-4 bg-gradient-to-r from-red-600 to-blue-600 text-center">
        Have you heard of what our Amazing Congregations are doing?
      </h3>
